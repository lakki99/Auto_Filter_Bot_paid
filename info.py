...
# ============================
SESSION = environ.get('SESSION', 'lakkisbots_search')   # Session name for the bot
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8153928495').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003557398948').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003628413767'))  # Log channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://demob261_db_user:lakkisbots@cluster0.g5z2ije.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "lakkisbots") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'lakkisbots_files') # Collection name (default: dreamcinezone_files)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/lakkis_support') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/lakkisbots') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/lakkisbots') # Update channel link for the bot
